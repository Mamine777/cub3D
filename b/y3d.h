...
/*   Updated: 2025/02/02 16:46:24 by mokariou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// BONUS
void				draw_player_direction(t_player *player, t_game *game);
void				draw_map(t_game *game);
void				draw_square(int x, int y, int size, t_game *game);
void				draw_player(t_player *player, t_game *game);
void				draw_lol(t_player *player, t_game *game, float start_x);
